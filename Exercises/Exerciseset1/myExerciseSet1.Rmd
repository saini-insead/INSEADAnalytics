...
<br>
<br>
quantmod and Quandl are two R packages used to extract financial time-series from internet sources.
<hr>
<hr>
...
<br>
<br>
Q1. File dataSet1.R, mytickers = c("SPY", "AAPL")
<br>
<br>
Q2.   
Cumulative Return: `round(100*sum(StockReturns[,2]),1)` %
<br>
Average Daily Return: `round(100*mean(StockReturns[,2]),3)` %
<br>
Standard Deviation: `round(100*sd(StockReturns[,2]),3)` %
<br>
<br>
<hr>
<hr>
...
**Your Answers here:**
<br>
Q1. Define `transposedData = t(StockReturns)`
<br>
For rows: `nrow(transposedData)`
<br>
For columns: `ncol(transposedData)`
<br>
<br>
Q2. 
<br>
...
**Your Answers here:**
<br>
Q1. Change line `start date = "2005-01-01"` to `start date = "2001-01-01"`
<br>
<br>
<br>
...
**Your Answers here:**
<br>
Q1. The Console gives an answer 20, which is incorrect due to an error. During the csv file load, `,` needs to be used instead of `;`.
<br>
<br>
<br>
