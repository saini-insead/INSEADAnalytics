...
*
Q1. 6 factors are needed to explain at least 50% of the variance in the data.
<br>
<br>
*
Q2. The highest weight = 0.93
<br>
<br>
*
Q3. Yes, these factors are as follows:
* Component 1: American Bonds
* Component 2: Currencies
* Component 3: European Stock Market Index
* Component 4: North American Stock Market Index
* Component 5: European Bonds
* Component 6: Oil Prices
* Component 7: Prices of metals such as Aluminum
* Component 8: Food commodities - corn, soybeans etc.
* Component 9: Precious Metals - Gold, Silver, etc
* Component 10: Asian Stock Market Index
<br>
<br>
* Q4. Pre-crisis Years:
<br>
...
pre_crisis_components <- PCA(pre_crisis_data, graph=FALSE)
pre_crisis_table <- pre_crisis_components$eig
colnames(pre_crisis_table) <- c("Eigenvalue","% of explained variance", "Cumulative % of explained variance")
eigen_before_crisis <- before_crisis_table[,"Eigenvalue"]
plot(eigen_before_crisis)
lines(rep(1,length(eigen_before_crisis)))
```
<br>
Crisis Years
```{r}
...
plot(eigen_crisis,)
lines(rep(1,length(eigen_crisis)))
```
<br>

* Q5. Before the crisis, the returns seem less correlated than during the crisis. During the crisis, fewer factors are needed to explain the variance.  
<br>
<br>
...
*
Q1. This code uses time-periods of different lengths to calculate a moving average. From these averages, the weights (totalling 1) are found, and these weights are multiplied by the futures prices to calculate the amount to be invested in each of the futures.  
<br>
<br>
